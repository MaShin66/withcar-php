...
$sms['user_id'] = "ubiquitous6"; // SMS 아이디
$sms['key'] = "8f1i16t2t8g4ccf2inz4gmdom35yyxxb";//인증키
/****************** 인증정보 끝 ********************/

/****************** 전송정보 설정시작 ****************/
$_POST['msg'] = '%고객명%님. 안녕하세요. API TEST SEND'; // 메세지 내용 : euc-kr로 치환이 가능한 문자열만 사용하실 수 있습니다. (이모지 사용불가능)
$_POST['receiver'] = '01041119132'; // 수신번호
$_POST['destination'] = '01041119132|신호태'; // 수신인 %고객명% 치환
$_POST['sender'] ="01041119132"; // 발신번호
