...
<div><h1><a href="withcar/signup">이메일로 회원가입</a></h1></div>
...
<form action="withcar/ridecheck" method="post">
...
<script>
    ...
    function displayInfowindow(marker, title, latitude, longitude) {        
        ...
        if(!document.getElementById("depature").value == '') {
            ...
            document.getElementById("depature").value = title;
            document.getElementById("depature_latitude").value = latitude;
            document.getElementById("depature_longitude").value = longitude;
        }
